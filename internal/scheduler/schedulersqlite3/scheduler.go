...
func (r *repo) Put(ctx context.Context, in *goqmodel.Scheduler) (*goqmodel.Scheduler, error) {
...
func (r *repo) Get(ctx context.Context, id string) (*goqmodel.Scheduler, error) {
	row := r.db.QueryRowx(`
		SELECT
			id,
			schedule,
...
func (r *repo) List(ctx context.Context, args *goqmodel.ListSchedulersRequest) (*goqmodel.ListSchedulersResponse, error) {
	...
	schedulers := make([]*goqmodel.Scheduler, 0, sz)
	for rows.Next() {
		var r schedulerRow
	...
	return &goqmodel.ListSchedulersResponse{
...
func schedulerRowToScheduler(r *schedulerRow) (*goqmodel.Scheduler, error) {
